...
Definition at line 171 of file packop.\+py.


\begin{DoxyCode}
171     \textcolor{keyword}{def }\hyperlink{classsrc_1_1packop_1_1_package_a68ab82eb13694098303f2533424ad1d3}{add\_point}(self, coord):
172         segment = self.\hyperlink{classsrc_1_1packop_1_1_package_adf44f03c6ae7b279f60019d07e59891c}{coords}[-1]
173         vehicle = self.\hyperlink{classsrc_1_1packop_1_1_package_a5ae1df593cc8e7e0cf5578d2ef7112f5}{get\_vehicle}(coord)
174         \textcolor{keywordflow}{if} vehicle != self.\hyperlink{classsrc_1_1packop_1_1_package_a5ae1df593cc8e7e0cf5578d2ef7112f5}{get\_vehicle}(segment[-1]):
175             self.coords.append([])
176             \textcolor{keywordflow}{if} vehicle == 0:
177                 \textcolor{keywordflow}{if} self.\hyperlink{classsrc_1_1packop_1_1_package_a9b051e33800c5a152ad902f886757d26}{seen\_land}:
178                     self.land\_speeds.append(0)
179                 \textcolor{keywordflow}{else}:
180                     self.\hyperlink{classsrc_1_1packop_1_1_package_a9b051e33800c5a152ad902f886757d26}{seen\_land} = \textcolor{keyword}{True}
181             \textcolor{keywordflow}{else}:
182                 \textcolor{keywordflow}{if} self.\hyperlink{classsrc_1_1packop_1_1_package_a47ad90cdc00f18fca0d9499e89a6baab}{seen\_water}:
183                     self.water\_speeds.append(0)
184                 \textcolor{keywordflow}{else}:
185                     self.\hyperlink{classsrc_1_1packop_1_1_package_a47ad90cdc00f18fca0d9499e89a6baab}{seen\_water} = \textcolor{keyword}{True}
186             self.poi.append([coord, vehicle])
187         self.\hyperlink{classsrc_1_1packop_1_1_package_adf44f03c6ae7b279f60019d07e59891c}{coords}[-1].append(coord)
188         \textcolor{keywordflow}{if} vehicle == 0:
189             self.\hyperlink{classsrc_1_1packop_1_1_package_a6de40c006b5febc83838475246a10f13}{land\_speeds}[-1] = self.\hyperlink{classsrc_1_1packop_1_1_package_afcc4f2e177f4ca3cc99c17ca052d51b7}{get\_speed}()
190         \textcolor{keywordflow}{else}:
191             self.\hyperlink{classsrc_1_1packop_1_1_package_a4fd9fe5f73cb34aa5b5c7029f024d4f6}{water\_speeds}[-1] = self.\hyperlink{classsrc_1_1packop_1_1_package_afcc4f2e177f4ca3cc99c17ca052d51b7}{get\_speed}()
192         self.\hyperlink{classsrc_1_1packop_1_1_package_ad51ff69ce00ee5c869723c572db0eefd}{speeds} = [\hyperlink{namespacesrc_1_1packop_ab638c612d9512dd1f5b3200461af63c9}{average}(self.\hyperlink{classsrc_1_1packop_1_1_package_a6de40c006b5febc83838475246a10f13}{land\_speeds}), 
...
193         self.\hyperlink{classsrc_1_1packop_1_1_package_a93606e6aea9563f73484a536c9c5636d}{dist} = \hyperlink{namespacesrc_1_1packop_ac16b65508182630b4ab800bffc0d06f0}{vincenty}(coord[:2], self.\hyperlink{classsrc_1_1packop_1_1_package_a78018be0196ca47c5ce84ad62a0d4dba}{destination})
194 
\end{DoxyCode}
...
Definition at line 220 of file packop.\+py.


\begin{DoxyCode}
220     \textcolor{keyword}{def }\hyperlink{classsrc_1_1packop_1_1_package_af57f2a1649a5a1346d4f4843084942af}{etr}(self):
221         segment = self.\hyperlink{classsrc_1_1packop_1_1_package_adf44f03c6ae7b279f60019d07e59891c}{coords}[-1]
222         coord = segment[-1][:2]
223         land\_speed, water\_speed = self.\hyperlink{classsrc_1_1packop_1_1_package_ad51ff69ce00ee5c869723c572db0eefd}{speeds}
224         pixel1, pixel2 = \hyperlink{namespacesrc_1_1packop_a51973541dd75d68571c154ad06a2d4df}{to\_pixel}(coord), \hyperlink{namespacesrc_1_1packop_a51973541dd75d68571c154ad06a2d4df}{to\_pixel}(self.
      \hyperlink{classsrc_1_1packop_1_1_package_a78018be0196ca47c5ce84ad62a0d4dba}{destination})
225         line = \hyperlink{namespacesrc_1_1packop_a0bcffd2956685d6954e2059daed5a46d}{generate\_line}(pixel1, pixel2)
226         interval = self.\hyperlink{classsrc_1_1packop_1_1_package_a93606e6aea9563f73484a536c9c5636d}{dist} / len(line)
227         surfaces = list(map(over\_land, line))
228         land\_time = surfaces.count(\textcolor{keyword}{True}) * interval / land\_speed
229         water\_time = surfaces.count(\textcolor{keyword}{False}) * interval / water\_speed
230         \textcolor{keywordflow}{return} land\_time + water\_time
231 \end{DoxyCode}
...
Definition at line 201 of file packop.\+py.


\begin{DoxyCode}
201     \textcolor{keyword}{def }\hyperlink{classsrc_1_1packop_1_1_package_afcc4f2e177f4ca3cc99c17ca052d51b7}{get\_speed}(self):
202         segment = self.\hyperlink{classsrc_1_1packop_1_1_package_adf44f03c6ae7b279f60019d07e59891c}{coords}[-1]
203         \textcolor{keywordflow}{if} len(segment) > 1:
204             coord1 = segment[0][:3]
205             time1 = segment[0][3]
206             coord2 = segment[-1][:3]
207             time2 = segment[-1][3]
208             distance = \hyperlink{namespacesrc_1_1packop_ac16b65508182630b4ab800bffc0d06f0}{vincenty}(coord1[:2], coord2[:2])
209             time = time2 - time1
210             \textcolor{keywordflow}{return} abs(distance / time)
211         \textcolor{keywordflow}{else}:
212             vehicle = self.\hyperlink{classsrc_1_1packop_1_1_package_a5ae1df593cc8e7e0cf5578d2ef7112f5}{get\_vehicle}(segment[-1])
213             \textcolor{keywordflow}{return} DEFAULT\_SPEEDS[vehicle]
214 
\end{DoxyCode}
...
Definition at line 159 of file packop.\+py.


\begin{DoxyCode}
159     \textcolor{keyword}{def }\hyperlink{classsrc_1_1packop_1_1_package_a5ae1df593cc8e7e0cf5578d2ef7112f5}{get\_vehicle}(self, coord):
160         x, y = \hyperlink{namespacesrc_1_1packop_a51973541dd75d68571c154ad06a2d4df}{to\_pixel}(coord[:2])
161         \textcolor{keywordflow}{if} \textcolor{keywordflow}{not} \hyperlink{namespacesrc_1_1packop_a6ac8ed111ff691f9bec1c25c44e04af9}{over\_land}((x, y)):
...
Definition at line 146 of file packop.\+py.
