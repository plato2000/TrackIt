...
Definition at line 176 of file database\+\_\+storage.\+py.


\begin{DoxyCode}
176 \textcolor{keyword}{def }\hyperlink{namespacesrc_1_1database__storage_ac8bfcdfbcc3f0aeb1244c86f125e89dc}{clear\_database\_and\_create\_new}():
177     \textcolor{comment}{# command = "DROP DATABASE idt; CREATE DATABASE idt;"}
178     command1 = \textcolor{stringliteral}{"CREATE TABLE uuids (uuid CHAR(36) PRIMARY KEY, nameString TINYBLOB, delivered ENUM('Y', 'N'
      ), destLat DOUBLE(7, 4), destLon DOUBLE(7,4));"}
179     \textcolor{comment}{# execute\_command(command)}
180     \hyperlink{namespacesrc_1_1database__storage_a7b71f3e5bfe1e4372d048f23e8ca7ed4}{execute\_command}(command1)
181     \textcolor{comment}{# execute\_command("USE idt")}
182 
183 
\end{DoxyCode}
...
Definition at line 171 of file database\+\_\+storage.\+py.


\begin{DoxyCode}
171 \textcolor{keyword}{def }\hyperlink{namespacesrc_1_1database__storage_ac8226df71c58ddf9a1d4de0e89a63bc9}{close\_database}():
172     db.close()
173 
174 
\end{DoxyCode}
...
Definition at line 190 of file database\+\_\+storage.\+py.


\begin{DoxyCode}
190 \textcolor{keyword}{def }\hyperlink{namespacesrc_1_1database__storage_a7b71f3e5bfe1e4372d048f23e8ca7ed4}{execute\_command}(command, results=False):
191     \textcolor{keywordflow}{try}:
192         cursor.execute(command)
193         \textcolor{keywordflow}{if} results:
194             \textcolor{keywordflow}{return} cursor.fetchall()
195         \textcolor{keywordflow}{else}:
196             db.commit()
197             \textcolor{keywordflow}{return} \textcolor{keyword}{True}
198     \textcolor{keywordflow}{except}:
199         traceback.print\_exc(file=sys.stdout)
200         db.rollback()
...
165     results = \hyperlink{namespacesrc_1_1database__storage_a7b71f3e5bfe1e4372d048f23e8ca7ed4}{execute\_command}(\textcolor{stringliteral}{"SELECT delivered FROM uuids WHERE uuid='"} + uuid + \textcolor{stringliteral}{"'"}, 
      results=\textcolor{keyword}{True})
166     \textcolor{comment}{# print "delivery\_status:", results}
167     \textcolor{keywordflow}{return} results[0] == \textcolor{stringliteral}{'Y'}
168 
169 
\end{DoxyCode}
...
Definition at line 208 of file database\+\_\+storage.\+py.
